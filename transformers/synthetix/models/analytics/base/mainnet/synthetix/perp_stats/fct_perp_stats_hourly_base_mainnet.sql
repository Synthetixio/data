...
inc as (
    select
        h.ts as ts,
        h.trades as trades,
        h.exchange_fees as exchange_fees,
        h.referral_fees as referral_fees,
        h.collected_fees as collected_fees,
        h.volume as volume,
        h.cumulative_exchange_fees as cumulative_exchange_fees,
        h.cumulative_referral_fees as cumulative_referral_fees,
        h.cumulative_collected_fees as cumulative_collected_fees,
        h.cumulative_volume as cumulative_volume,
        COALESCE(
