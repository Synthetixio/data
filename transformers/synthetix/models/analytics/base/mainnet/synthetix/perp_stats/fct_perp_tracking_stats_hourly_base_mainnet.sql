{{ config(
    materialized = "view",
    tags = ["perp", "tracking", "stats", "hourly", "base", "mainnet"]
) }}
...
select
    ...
    trades.exchange_fees as exchange_fees,
    trades.referral_fees as referral_fees,
    trades.collected_fees as collected_fees,
    trades.volume as volume,
    trades.trades as trades,
