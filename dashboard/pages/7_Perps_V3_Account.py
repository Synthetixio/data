...
with st.expander("Look up accounts by address"):
    address = st.text_input("Enter an address to look up the account number")
...
last_liq = (
    data["account_liq"].loc[data["account_liq"]["account_id"] == account, "ts"].max()
)
