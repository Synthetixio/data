...
def load_data(*args, **kwargs):
    ...
    # currenly only valid for arbitrum and base
    networks = ['arbitrum_mainnet', 'base_mainnet', 'eth_mainnet']
    if raw_db not in networks:
        raise Exception(f"Only, {'[' + ', '.join(networks) + ']'} available at the moment !")
